...
import { StampsPage } from "../target/types/stamps_page";
...
describe("Stamp Pages", () => {
  ...
  const program = anchor.workspace.StampsPage as Program<StampsPage>;
  ...
  it("Is initialized!", async () => {
    ...
    const accountData = await program.account.stampsPage.fetch(account.publicKey);
